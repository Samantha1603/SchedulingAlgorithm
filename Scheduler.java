...
class Scheduler
{
    ...
    public static void main(String args[])
    {
        ...
        switch(choice)
        {
            ...
            case 7: System.out.println();
                    ...
                    sort(list_of_all_processes,"Arrival_time");
                    HPF_NP_Aging(list_of_all_processes);
                    restore(list_of_all_processes);
                    System.out.println("----------------------------------------END--------------------------------------------------\n\n");
                    break;
            case 8: System.out.println();
                    ...
                    sort(list_of_all_processes,"Arrival_time");
                    HPF_P_Aging(list_of_all_processes);
                    restore(list_of_all_processes);
                    System.out.println("----------------------------------------END--------------------------------------------------\n\n");
                    break;
        }
    ...
    public static void display(Process list_of_all_processes[])                 // Function to display Process array in tablular form
    {
        ...
        {
            // Print Data
            System.out.println(list_of_all_processes[i-1].Pid+"\t"+df.format(list_of_all_processes[i-1].Arrival_time)+"\t\t\t"+df.format(list_of_all_processes[i-1].original_Execution_time)+"\t\t\t"+list_of_all_processes[i-1].original_Priority
                    +"\t\t\t"+list_of_all_processes[i-1].Completed_time+"\t\t\t"+df.format(list_of_all_processes[i-1].Turnaround_Time)+
                    "\t\t\t"+df.format(list_of_all_processes[i-1].Wait_time)+"\t\t\t"+df.format(list_of_all_processes[i-1].Response_time));
        }
    }
    ...
    public static void HPF_P_Aging(Process list_of_all_processes[])  // Function to simulate Highest Priority First (Preemptive type) with aging. Similar to Highest Priority First (Preemptive type)
    {
        int time = 0;
        double sumTT = 0;
        double sumWT = 0;
    ...
    public static void HPF_NP_Aging(Process list_of_all_processes[])  // Function to simulate Highest Priority First (Non-preemptive type) with aging. Similar to Highest Priority First (Non-preemptive type)
    {
        int time = 0;
        double sumTT = 0;
        double sumWT = 0;
    ...
    public static void HPF_P(Process list_of_all_processes[])  // Function to simulate Highest Priority First (Preemptive type) without aging process
    {
        ...
        while(time<=1000)                                                       // Initialize time to 1000 (arbitary number) for simulation
        {
            ...
            {
                // Find out all the process which have arrived, not yet completed and not yet in ready state ArrayList based on the flag value
                if(list_of_all_processes[i].Arrival_time <= time && list_of_all_processes[i].flag && check(list_of_all_processes[i],ready_state_processes))  
                {
        ...
        sort(list_of_all_processes,"Completed_time");                           // Requires the Completed time of last Process in the queue to calculate Throughput
    ...
    public static void HPF_NP(Process list_of_all_processes[])  // Function to simulate Highest Priority First (Non-preemptive type) without aging process
    {
        int time = 0;                                                           // Initialize time simulation to 0
        double sumTT = 0;                                                       // Initialize the sum of turnaround time to 0 (Used to calculate average)
        double sumWT = 0;                                                       // Initialize the sum of wait time to 0 (Used to calculate average)
    ...
    public static void RR(Process list_of_all_processes[])    // Function to simulate Round Robin with time quanta = 2
    {
        int time = 0;                                                           // Initialize time simulation to 0
        double sumTT = 0;                                                       // Initialize the sum of turnaround time to 0 (Used to calculate average)
        double sumWT = 0;                                                       // Initialize the sum of wait time to 0 (Used to calculate average)
        ...
        while(time<=1000)                                                       // Initialize time to 1000 (arbitary number) for simulation
        {
            for(int i=0; i< list_of_all_processes.length;i++)                   // Iterate over all the processes
            {
                if(list_of_all_processes[i].Arrival_time <= time && list_of_all_processes[i].flag && checkRR(list_of_all_processes[i],ready_state_processes))     
                {
                    // Find out all the process which have arrived, not yet completed and not yet in ready state ArrayList based on the flag value
                    ready_state_processes.add(list_of_all_processes[i]);        // Add processes to the ready List
                }
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        // Repeat the above same steps of statstics calculation if the remaining Execution time is less than 1 time unit and greater than 0.
                        if(current_running_process.Execution_time<1 && current_running_process.Execution_time>0) 
                        {
                            time = time + 1;
                            System.out.print("[P"+current_running_process.Pid+"]");
                            current_running_process.Execution_time = 0;
    ...
    public static void SRT(Process list_of_all_processes[])    // Function to simulate Shortest Remaining Time
    {
        int time = 0;                                                           // Initialize time simulation to 0
        double sumTT = 0;                                                       // Initialize the sum of turnaround time to 0 (Used to calculate average)
        double sumWT = 0;                                                       // Initialize the sum of wait time to 0 (Used to calculate average)
    ...
    public static void SJF(Process list_of_all_processes[])     // Function to simulate Shortest Job First
    {
        int time = 0;                                                           // Initialize time simulation to 0
        double sumTT = 0;                                                       // Initialize the sum of turnaround time to 0 (Used to calculate average)
        double sumWT = 0;                                                       // Initialize the sum of wait time to 0 (Used to calculate average)
    ...
    public static void FCFS(Process list_of_all_processes[])    // Function to simulate First Come First Serve
    {
        int time = 0;                                                           // Initialize time simulation to 0
        double sumTT = 0;                                                       // Initialize the sum of turnaround time to 0 (Used to calculate average)
        double sumWT = 0;                                                       // Initialize the sum of wait time to 0 (Used to calculate average)
